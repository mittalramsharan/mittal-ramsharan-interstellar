...
To build the final jar and optimize the mittalRamsharanInterstellar application for production, run:
...
Then navigate to [http://localhost:8237](http://localhost:8237) in your browser.
